...
<div class="p-6 bg-gray-100 min-h-screen">
    <h1 class="text-2xl font-bold mb-4">Data Arsip Lansia </h1>
    ...
    <div class="bg-white border-l-4 border-blue-500 p-4 mb-4 shadow rounded">
        <p class="text-gray-700">
            ...
            <span class="font-semibold text-red-600">Meninggal</span>, atau
    ...
    <?php else : ?>
        <div class="mt-4 text-center">
            <p class="text-red-500">Tidak ada data lansia baru untuk dikonfirmasi.</p>
        </div>
    <?php endif; ?>
</div>
...
<script>
    ...
    document.getElementById("btnLanjutKonfirmasi").addEventListener("click", function() {
        fetch(`/admin/data-arsip-lansia/konfirmasi/${idTerpilih}`, {
                method: 'POST',
                headers: {
    ...
    document.getElementById("btnLanjutHapus").addEventListener("click", function() {
        fetch(`/admin/data-arsip-lansia/hapus/${idTerpilih}`, {
            method: 'DELETE',
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            }
