...
<div class="container mx-auto p-4">
    <h2 class="text-xl font-bold mb-4">Tambah Data Remaja Putri</h2>

    <form id="remajaForm" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label>NIK</label>
        ...
        <div>
            ...
            <input type="text" name="nama_lengkap" class="border p-2 w-full" required>
        </div>
        ...
        <div>
            ...
            <select name="golongan_darah" class="border p-2 w-full">
        ...
        <div>
            ...
            <input type="text" name="kadar_hb" class="border p-2 w-full" required>
        </div>

        <div>
            <label>Alamat</label>
            <select name="alamat" class="border p-2 w-full">
                <?php for ($i = 1; $i <= 10; $i++) : ?>
        ...
        <div>
            ...
            <input type="text" name="nomor_telepon" class="border p-2 w-full" required>
        </div>
    </form>
...
<div id="modalKonfirmasi" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white p-6 rounded shadow-lg">
        ...
        <div class="mt-4 flex justify-end">
            ...
            <button id="konfirmasi" class="bg-blue-600 text-white px-4 py-2 rounded">Simpan</button>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById("konfirmasi").onclick = () => {
        ...
        fetch("<?= base_url('/admin/remajaputri/simpan') ?>", {
            method: "POST",
            body: formData
        })
        .then(res => res.json())
    ...
    document.getElementById("tutupModal").onclick = () => location.href = "<?= base_url('/admin/data-remaja-putri') ?>";
