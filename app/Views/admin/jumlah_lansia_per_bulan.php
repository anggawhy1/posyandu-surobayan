...
<div class="p-6 bg-gray-100 min-h-screen">
    <h1 class="text-2xl font-bold mb-4">Input Jumlah Lansia Per Bulan</h1>

    


<!-- Form untuk input jumlah balita per bulan -->
<form action="<?= base_url('/admin/jumlah-lansia-per-bulan/save') ?>" method="post">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <!-- Input jumlah balita -->
        <div class="mb-4">
            <label class="block text-gray-700 font-semibold">Jumlah Lansia</label>
    ...
    <h2 class="mt-8 text-xl font-bold mb-4">Data Jumlah Lansia Per Bulan</h2>
    <?php if (!empty($jumlahLansia)): ?>
            ...
            <table class="table-auto w-full border-collapse bg-white text-gray-800">
                <thead class="bg-gray-700 text-white">
                    <tr>
                        ...
                        <th class="p-3 text-center border">Jumlah Lansia</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($jumlahLansia as $item): ?>
                        <tr class="border-b hover:bg-gray-100">
                            <td class="p-3 text-center"><?= esc($item['bulan']) ?></td>
                            <td class="p-3 text-center"><?= esc($item['jumlah_lansia']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
    ...
    <?php else: ?>
        <p class="text-red-500">Belum ada data jumlah lansia per bulan.</p>
    <?php endif; ?>
</div>
